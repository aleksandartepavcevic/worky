    ...
    return (
        <div className="container relative">
            ...
            <main
                ...
                <div className="absolute top-3/4 w-full md:w-2/3 rounded-2xl overflow-hidden">
                ...
                <div className="flex flex-col items-center gap-10">
                    ...
                    <div className="flex flex-col items-center gap-4 text-center">
                        ...
                        <Typography
                            variant="h4"
                            className="max-w-lg text-accent-foreground font-light">
                            Discover how our features can simplify your project
                            management process and enhance team collaboration.
                        </Typography>
                    </div>
                ...
                <div className="flex flex-col items-center gap-10">
                    ...
                    <div className="flex flex-col items-center gap-4 text-center">
                        ...
                        <Typography
                            ...
                            to join our team. Check out our current job
                            openings.
                        </Typography>
                    </div>
